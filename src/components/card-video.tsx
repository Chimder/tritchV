        ...
        <div className="absolute left-0 top-0 flex h-full w-full flex-col justify-between p-3 md:p-4">
          <div className="relative flex items-start justify-between text-sm">
            ...
            <div className="mx-1 flex h-2 items-center  rounded-full text-white">
              <span className="font-bold">
                {type === 'stream' && (
                  <Badge className="rounded-full bg-red-600 text-white">Live</Badge>
                )}
                ...
                {type === 'clips' && (
                  <Badge className="rounded-full bg-black/80 text-white">{video.duration} s</Badge>
                )}
              </span>
            </div>
          </div>
          <div className="flex items-end text-sm">
            <div className="overflow-hidden ">
              <div className="text-base font-bold text-white">{video?.user_login}</div>
